...
(0, _jquery2.default)(document).ready(function () {
  var tabletbp = _foundationSites2.default.MediaQuery.get("tablet"),
      xlargebp = _foundationSites2.default.MediaQuery.get("xlarge");
  (0, _jquery2.default)(".owl-testi").owlCarousel({
    loop: false,
    dots: true,
    responsive: {
      0: {
  ...
  (0, _jquery2.default)(".owl-slider").owlCarousel({
    autoWidth: true,
    loop: true,
    nav: true,
    navText: ["‹", "›"],
